import{$ as p}from"./scheduler.01ba8032.js";function $(n){const t=n-1;return t*t*t+1}function C(n,{delay:t=0,duration:a=400,easing:e=$,x:f=0,y:i=0,opacity:s=0}={}){const o=getComputedStyle(n),c=+o.opacity,y=o.transform==="none"?"":o.transform,m=c*(1-s),[u,r]=p(f),[d,_]=p(i);return{delay:t,duration:a,easing:e,css:(l,g)=>`
